module.exports = function(scope, name){
  ...
  this.needsEach = function(items, fn, fnArgs) {
    ...
    var f = function(n, fn, fArgs){
      for (var i = 0; i < n.length; i++)
        ...
        // I change the .apply(this... to .apply(that , seems to correct the bug, but I don't fucking remember why I put that this in the first place
        // So I might have broke something ... dunno.
    }
  ...
  this.needs = function(fn){  
    ...
    var f = (cb) ? fn : function(){
      that._cb_needs.call(that, {arguments: arguments, results: fn.apply(this._scope, arguments)});
    }
